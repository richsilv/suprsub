var tour = {
	...
	steps: [
...

		{
			...
			buttonText: 'Done',
			target: '#main-background-image',
			targetTemplate: 'playerDetails'
		}
...
appVars = (function() {
	...
	return {
		...
		mapReady: new suprsubDep(false),
		pitchesReady: new suprsubDep(false),
		...
		mainOption: '/',
		s3Url: 'https://s3-eu-west-1.amazonaws.com/suprsub/',
